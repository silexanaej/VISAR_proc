...
def get_HM_poly(name, window):
    ...
    S1_poly_t = {
            ...
            '1us':np.array([+9.675e+02, +1.124e-01, -3.995e-05, +7.501e-09])*1e-3
            }
    ...
    S2_poly_t = {
            ...
            '1us':np.array([+9.375e+02, +1.854e-01, -2.196e-04, +1.369e-07])*1e-3
            }
    ...
    S3_poly_t = {
            ...
            '1us':np.array([+1.008e+03, +9.289e-02, -4.759e-05, 0])*1e-3
            }
