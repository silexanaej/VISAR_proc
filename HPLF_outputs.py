...
class HPLF_outputs():
    def __init__(self, data_dir, I0=True, metadata=True):
        # datadir
        ...
        # metadata
        self.metadata_fi = 'metadata.dat'
        # oscillos
        self.oscillo_dir = 'oscillos/'
        ...
        # p100
        self.p100_dir = 'p100/'
        self.modbox_fi = 'modbox_profile.dat'
        self.ff_amplifier_fi = 'ff_amplifier.png'
        self.nf_amplifier_fi = 'nf_amplifier.png'
        self.ff_intrepid_out_fi = 'ff_out_frontend_intrepid.png'
        self.nf_intrepid_out_fi = 'nf_out_frontend_intrepid.png'
        self.nf_intrepid_regen_fi = 'nf_regen_intrepid.png'
        # cameras eh1
        self.cameras_eh1_dir = 'cameras/'
        self.ff_eh1_fi = self.cameras_eh1_dir + os.sep + 'bas_ff.png'
        self.nf_eh1_fi = self.cameras_eh1_dir + os.sep + 'bas_nf.png'
        # streak cameras 
        self.streak_dir = 'streak/'
    ...
    def plot_VISAR_images(self, S1_param, S2_param, calibrated=True, cmap='binary'):   
        if self.sequence in ['laser_only', 'shock', 'streak_ref']: 
            ...
            if calibrated==True: #calibrated images
                ...
                ax1.pcolormesh(grid_tV1, grid_sV1, self.VISAR1.im.transpose(), vmax=np.max(self.VISAR1.im)/3, cmap=cmap)
                ...
                ax2.pcolormesh(grid_tV2, grid_sV2, self.VISAR2.im.transpose(), vmax=np.max(self.VISAR2.im)/3, cmap=cmap)
